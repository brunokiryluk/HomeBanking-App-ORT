...
namespace MVCHomeBanking.Controllers
{
    public class ClientController : Controller
    {
        ...
        public ClientController(HomeBankingContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("clientId,name,surname,nroDoc,phone")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("clientId,name,surname,nroDoc,phone")] Client client)
        {
